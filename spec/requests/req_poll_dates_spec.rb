...
RSpec.describe "PollDates", type: :request do
  ...
  let!(:invalid_attributes) { { type:'PollDate', question: nil, expiration_date: nil } }
  let!(:invalid_attributes_question_only) { { type:'PollDate', question: "", expiration_date: Date.today } }
    ...
    describe "POST #create" do
      context "with valid params" do
        ...
        it "redirects to the created poll" do
          post '/poll_dates', params: { poll_date: valid_attributes }
          t = PollDate.find_by(question: valid_attributes[:question])
          expect(response).to redirect_to polls_path
        end
      end
      ...
      context "with invalid params" do
        it "re-renders the 'new' template" do
          post '/poll_dates', params: { poll_date: invalid_attributes_question_only }
